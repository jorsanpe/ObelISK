...
#ifndef _ITRONSYS_SYSMGMT_H_
#define _ITRONSYS_SYSMGMT_H_
...
/*
 *  get_ver_sys - Get Version Information
 */
...
/*
 *  ref_sys_sys - Reference Semaphore Status
 */
...
/*
 *  ref_cfg_sys - Reference Configuration Information
 */
...
/*
 *  def_svc_sys - Define Extended SVC Handler
 */
...
/*
 *  def_exc_sys - Define Exception Handler
 */
...
/*
 * dis_dsp_sys - Disable dispatching
 */
ER dis_dsp_sys();

/*
 * ena_dsp_sys - Enable dispatching
 */
ER ena_dsp_sys();
