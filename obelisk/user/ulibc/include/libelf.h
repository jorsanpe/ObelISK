...
// Flash Entry types
#define FL_ENTRY_APP 0
#define FL_ENTRY_LIB 1

#define FL_ENTRY_MAGIC 0xB00710AD
#define FL_ENTRY_EOF   0xFFFFFFFF

typedef struct flash_entry_struct {
   int magic;                       // Flash Header Magic number
   char name[32];                   // Application name
   unsigned int size;               // Application size
   int type;                        // Binary file type (dynamic library / application)
} flash_entry_t;
